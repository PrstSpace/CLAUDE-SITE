...
export async function registerForEvent(
  ...
  if (!data.consentGiven) {
    return {
      ...
      fieldErrors: {
        consentGiven:
          "Без вашего «да» персональным данным билет останется мечтой — а мы вообще-то создаём то, что другие считают невозможным. Отметьте галочку выше, и получите его.",
      },
    };
  }
